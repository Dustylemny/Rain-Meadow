...
namespace RainMeadow
{
    public static class ColorHelpers
    {
        ...
        public static void SaveMenuHSL(this Menu.Menu menu, SlugcatStats.Name id, int bodyIndex, string hslString)
        {
            if (id == null)
            {
                RainMeadow.Debug("WARNING! Failed to save color choices due to slugcat id input being null!");
                return;
            }
        ...
        {
            return id != null && menu.manager.rainWorld.progression.miscProgressionData.colorsEnabled != null && 
        ...
        public static HSLColor Vector3TOHSLColor(Vector3 vec)
        {
            return new(vec.x, vec.y, vec.z);
        }
        public static Vector3 SafeHSLRange(Vector3 hsl)
        {
